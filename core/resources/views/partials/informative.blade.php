<div class="dropdown d-inline-block">
  <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown"
    ...
    <img class="rounded-circle header-profile-user"
      src="{{ !empty(auth()->user()->profile) ? asset('assets/images/admin/profile/'.auth()->user()->profile) : asset('assets/images/noImage.png') }}"
      alt="Header Avatar">
  ...
  <div class="dropdown-menu dropdown-menu-end">
    <!-- item-->
    <a class="dropdown-item" href="{{ route('admin.admins.show', auth()->user()->id) }}"><i
