...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="adminSearch" method="POST">
                    <div class="row">
                        @include('admin.search')
                        @include('partials.search_button')
                    </div>
                </form>
                <table id="dataTableAdmin" class="table table-striped dt-responsive  nowrap w-100">
                    <thead>
                        <tr>
                            <th>
        ...
        $(document).ready(function() {
            ...
            $('#dataForm').on('submit', function(event) {
                ...
                if (id) {
                    ...
                    var method = 'store';
                    var url = "{{ route('admin.admins.store') }}";
                }
            ...
            $(document).on("click", ".editBtn", function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#dataForm #name").val(data.admin.name);
                        $("#dataForm #link").val(data.admin.link);
                        $("#dataForm #icon").val(data.admin.icon);
                        $("#dataForm #sequence").val(data.admin.sequence);
                        $("#dataForm #parent_id").val(data.admin.parent_id);
                        $("#dataForm #adminStatus").val(data.admin.status);
                        $("#dataForm #updateId").val(data.admin.id);
            ...
            $(document).on("click", "#bulk_action_delete", function(e) {
                ...
                if (id.length === 0) {
                    ...
                    var url = "{{ route('admin.admins.bulk_delete') }}";
