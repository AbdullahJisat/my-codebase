    ...
    var table;
        $(document).ready(function() {
            ...
            $(document).on("click", ".editBtn", function() {
                ...
                const genders = {'Male': 1, 'Female': 2, 'Other': 3}
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#dataForm #username").val(data.user.username);
                        $("#dataForm #email").val(data.user.email  );
                        $("#dataForm #mobile").val(data.user.mobile);
                        $("#dataForm #gender").val(genders[data.user.gender]);
                        $("#dataForm #userStatus").val(data.user.status);
                        $("#dataForm #password").hide();
            ...
            $(document).on("click", "#bulk_action_delete", function(e) {
                ...
                if (id.length === 0) {
                    ...
                    var url = "{{ route('admin.users.bulk_delete') }}";
