      ...
      <div class="card-body pt-0">
        <div class="row">
          <div class="col-sm-4 profile-photo">
            <form action="{{ route('admin.users.update_profile', $user->id) }}" method="post"
              ...
              {{-- <div class="avatar-md profile-user-wid mb-4"> --}}
                <img id="imagePreview"
                  src="{{ asset('assets/images/user/profile/' . @$user->profile) ?: asset('assets/images/noImage.png') }}"
        ...
        <div class="tab-content p-3 text-muted">
          <div class="tab-pane active" id="profileEdit" role="tabpanel">
            <form>
              ...
              <div class="row mb-4">
                ...
                <div class="col-sm-9">
                  <input type="mobile" class="form-control" id="mobile" name="mobile" value="{{ @$user->mobile }}"
          ...
          <div class="tab-pane" id="permissionChange" role="tabpanel">
            <form method="post" id="dataForm">
              @csrf
              <div class="row mb-4">
                @include('pages.user.permissions')
              </div>
...
<script>
  $(document).ready(function() {
            ...
            var url = `{{ route('admin.permissions_store') }}`;
                $.ajax({
                    url: url,
                    type: "POST",
                    data: data,
        ...
        function getPermissions(userId) {
            var url = `{{ route('admin.get_permissions') }}`;
            if (userId) {
                $.ajax({
                    url: url,
                    type: "POST",
